...
def create_app() -> FastAPI:
    ...
    app.include_router(bioelectric.router, prefix="/api/v2", tags=["bioelectric"])
    ...
    app.include_router(ml_proxy.router, prefix="/api/v2", tags=["ml-proxy"])
    app.include_router(structures.router, prefix="/api/v2", tags=["structures"])
    ...
    app.include_router(target_compare.router, prefix="/api/v2", tags=["target-compare"])
    app.include_router(target_report.router, prefix="/api/v2", tags=["target-report"])
    app.include_router(advisory_pack.router, prefix="/api/v2", tags=["advisory-pack"])
    ...
    app.include_router(proprioception.router, prefix="/api/v2", tags=["proprioception"])
    app.include_router(mouse_models.router, prefix="/api/v2", tags=["mouse-models"])
    app.include_router(agent.router, prefix="/api/v2", tags=["agent"])
