...
def create_app() -> FastAPI:
    ...
    app.include_router(molecule_browser.router, prefix="/api/v2", tags=["molecule-browser"])
    ...
    app.include_router(pockets.router, prefix="/api/v2", tags=["pockets"])
    ...
    SECTION_SLUGS = {
        ...
        "advisory", "analytics", "structures", "pockets",
    }
