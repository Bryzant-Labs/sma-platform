...
async def rank_all_candidates(top_n: int = 50) -> dict[str, Any]:
    ...
    for row in rows:
        ...
        candidates.append({
            ...
            "tpsa": screening_data["tpsa"],
            "hbd": screening_data["hbd"],
            "hba": screening_data["hba"],
            ...
            "hepatotox_risk": admet_data["hepatotox_risk"] if admet_data else None,
